...
//my paths
//"C:/Users/Work/Desktop/csc139/Assignment3/test/input1.txt"
//"C:/Users/Work/Desktop/csc139/Assignment3/test/myOutFile.txt"
public class a3 {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String RR = new String("RR");
			int switchInteger = 0;
			if (schedType.equals("RR")) {switchInteger=1;}
			if (schedType.equals("SJF"))switchInteger=2;
			if (schedType.equals("PR_noPREMP"))switchInteger=3;
			if (schedType.equals("PR_withPREMP"))switchInteger=4;
	...
	public static void roundRobin(int procs[][], int numOfProcs, int timeQuantum) {
		...
		ArrayList<Integer> fifoQ = new ArrayList();
			  ...
			  while(procFinished<numOfProcs) {
				  ...
				  if(cpuBusy==false&&fifoQ.size()>0) {
					  ...
					  if(hasCpu==hadCpu&&fifoQ.size()>1) { 
						  if(rrQ.contains(hasCpu))hasCpu = (int)rrQ.get(0);
	...
	public static void shortestJobFirst(int procs[][], int numOfProcs) {
		...
		ArrayList <Integer> doneProcs = new ArrayList();
		int procFinished = 0;
		int hasCpu = 0;
		int[] waits = new int[numOfProcs];
		double waitSum = 0;
	...
	public static void priority_withPREMP(int procs[][], int numOfProcs) {
		...
		int timeMark = 0;
		ArrayList<Integer> priorityQ = new ArrayList();
		ArrayList<Integer> doneQ = new ArrayList();
		int procFinished = 0;
